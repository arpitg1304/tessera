...
import { BarChart3, Target, Download, Zap } from 'lucide-react';
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm border">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h4 className="font-medium text-gray-900 mb-1">Generate Embeddings</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="font-medium text-gray-900 mb-1">Upload to Tessera</h4>
              <p className="text-sm text-gray-600">
            ...
            <div className="text-center">
              ...
              <h4 className="font-medium text-gray-900 mb-1">Explore & Sample</h4>
              <p className="text-sm text-gray-600">
            ...
            <div className="text-center">
              ...
              <h4 className="font-medium text-gray-900 mb-1">Train Better</h4>
              <p className="text-sm text-gray-600">
